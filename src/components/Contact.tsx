...
const Contact: React.FC = () => {
    ...
    // Function to handle form submission (this won't actually send an email, but opens the mail client)
    ...
    return (
        <>
            <Header /> {/* Keep the Header component outside the contact container */}
            <div className="contact-container">
                <div className="contact">
                    ...
                    <button className="back-button" onClick={handleBackClick}>{t('contact.backButton')}</button>
                </div>
            </div>
